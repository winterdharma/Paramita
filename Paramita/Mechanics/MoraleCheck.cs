...
namespace Paramita.Mechanics
{
    ...
    public class MoraleCheck
    {
        ...
        public MoraleCheck(SentientBeing checker, MoraleCheckType type, SentientBeing opponent = null, int modifier = 0)
        {
            dice2d6 = new Dice(2);
        ...
        private int GetSizeDifference(SentientBeing checker, SentientBeing opponent)
        {
            if(opponent != null)
